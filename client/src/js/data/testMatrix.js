...
export const TEST_MATRIX_APPLICATIONS = [
  // ---- Construction --------------------------------------------------
  {
    ...
    req: {
      xps: { level: 'required', note: 'Oxidation degree (C/O) drives dispersion & hydration nucleation.' },
  ...
  // ---- Carbon Capture ------------------------------------------------
  {
    ...
    req: {
      bet: { level: 'required', note: 'Accessible area & porosity set physisorption capacity; surface chemistry co-determines uptake.' },
  ...
  // ---- Energy Storage ------------------------------------------------
  {
    ...
    req: {
      ...
      bet: { level: 'required', note: 'Accessible surface area drives double-layer capacitance.' },
      raman: { level: 'required', note: 'I(D)/I(G) — defect density & reduction quality.' },
      purity: { level: 'recommended', note: "EDLC-grade carbons are spec'd for ash & trace Fe (leakage current)." },
  ...
  },
  {
    ...
    req: {
      ...
      'particle-size': { level: 'required', note: 'Oversize grit causes coating defects & shorts; conductive carbons carry grit specs.' },
      purity: { level: 'required', target: 'Fe ≤5 ppm, Ni ≤1 ppm (Super P Li benchmark)', note: 'Trace metals are critical for battery safety.' },
      moisture: { level: 'required', target: '≤0.1% (Super P Li benchmark)', note: "Water reacts with LiPF₆ electrolyte to form HF; powder moisture is spec'd on battery carbons." },
  ...
  },
  {
    ...
    req: {
      ...
      zeta: { level: 'required', note: 'Surface charge governs salt rejection & fouling behavior.' },
  ...
  },
  {
    ...
    req: {
      'particle-size': { level: 'required', note: 'Size dictates tribofilm formation; smaller flakes adsorb better and cut friction & wear.' },
