  ...
  return {
    ...
    async saveGraphene() {
      try {
        ...
        delete data.dateUnknown;
        delete data.semReportFile; // Remove file from data object
        ...
        if (this.grapheneForm.semReportFile) {
          formData.append('semReport', this.grapheneForm.semReportFile);
        }
    ...
    addNewResearchTeam() {
      if (this.newResearchTeam && !this.researchTeams.includes(this.newResearchTeam)) {
        ...
        // Set for whichever form is open
