    ...
    <div x-show="activeTab === 'compound-batches'" x-cloak>
      <div class="mb-6 flex justify-between items-center">
        ...
        <div class="flex space-x-2">
          ...
          <button x-show="canEdit()" @click="openCompoundBatchForm()" class="px-4 py-2 text-sm bg-black text-white rounded hover:bg-gray-800 touch-target">
            Create Batch
          </button>
        </div>
      </div>
              ...
              <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3 text-xs">
                  <div class="flex justify-end space-x-2">
                    <button x-show="canEdit()" @click="editCompoundBatch(batch)" class="text-link hover:text-link-hover" title="Edit">
                      <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                      </svg>
                    </button>
                    <button x-show="canEdit()" @click="deleteCompoundBatch(batch.id)" class="text-red-400 hover:text-red-600" title="Delete">
                      <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
