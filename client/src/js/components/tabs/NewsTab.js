              ...
              <template x-for="article in paginatedNewsArticles" :key="article.id">
                <article class="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
                  ...
                  <div class="p-6">
                    <div class="flex items-start justify-between mb-4">
                      <div class="flex items-center space-x-3">
                        ...
                        <template x-if="hasHighImpactKeyword(article)">
                          <span class="inline-flex items-center p-1 rounded-full bg-gray-900">
                    ...
                    <!-- Article Image -->
                    <div x-show="article.imageUrls && article.imageUrls.length > 0" class="mb-4 flex justify-center">
                      <img 
                        :src="article.imageUrls[0]" 
                        :alt="article.title"
                        @error="$event.target.style.display='none'"
                        class="max-w-full w-auto h-48 object-contain rounded-md"
                        loading="lazy">
                    </div>
                    ...
                    <div x-show="article.keywordTags && article.keywordTags.length > 0" class="mb-4">
                      <div class="flex flex-wrap gap-1">
                        <template x-for="tag in article.keywordTags.slice(0, 8)" :key="tag">
                          <span 
                            :class="isHighImpactKeyword(tag) ? 'bg-gray-100 text-gray-900 font-bold' : 'bg-gray-100 text-gray-700'"
